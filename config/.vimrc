...
"setl ff=unix fixeol             " For files in Unix format (every line NL terminated)
"setl ff=dos fixeol              " For old MS-DOS file in a modern environment
"setl ff=dos nofixeol noeol eof  " Drop the final <EOL> and add a final CTRL-Z
"setl nofixeol                   " Preserve the fileformat exactly as-is, including
                                 " any final <EOL> and final CTRL-Z.
